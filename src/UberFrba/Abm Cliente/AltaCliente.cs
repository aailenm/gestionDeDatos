...
namespace UberFrba.Abm_Cliente
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (validaciones())
            {
                bool conex = Conexion.executeProcedure("ALTA_CLIENTE", Conexion.generarArgumentos("@NOMBRE", "@APELLIDO", "@DNI", "@TELEFONO", "@MAIL", "@FECHA_NACIMIENTO", "@CALLE", "@PISO", "@DPTO", "@LOCALIDAD", "@CP"),
                nomb.Text, apell.Text, dni.Text, tel.Text, mail.Text, fechanac.Value.ToShortDateString(), calle.Text, piso.Text, dpto.Text, local.Text, cp.Text);
                if (conex) MessageBox.Show("Cliente creado correctamente");
                Limpiar();
            }
